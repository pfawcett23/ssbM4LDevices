{
	"patcher" : 	{
		"fileversion" : 1,
		"rect" : [ 21.0, 44.0, 629.0, 358.0 ],
		"bglocked" : 0,
		"defrect" : [ 21.0, 44.0, 629.0, 358.0 ],
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 395.0, 20.0, 25.0, 25.0 ],
					"varname" : "gain"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 235.0, 65.0, 100.0, 18.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 250.0, 100.0, 31.0, 18.0 ],
					"text" : "*~ 1."
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 135.0, 144.0, 80.0, 18.0 ],
					"text" : "lores~"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 250.0, 145.0, 62.0, 18.0 ],
					"text" : "lores~"
				}
...
, 			{
				"box" : 				{
					"annotation" : "Left audio signal (signal)",
					"comment" : "Left audio signal (signal)",
					"hint" : "Left audio signal (signal)",
					"id" : "obj-14",
					"maxclass" : "inlet",
					"numinlets" : 0,
					"numoutlets" : 1,
...
, 			{
				"box" : 				{
					"annotation" : "Right audio signal (signal)",
					"comment" : "Right audio signal (signal)",
					"hint" : "Right audio signal (signal)",
					"id" : "obj-15",
					"maxclass" : "inlet",
					"numinlets" : 0,
					"numoutlets" : 1,
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 250.0, 195.0, 25.0, 25.0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"hidden" : 0,
					"midpoints" : [ 164.5, 81.0, 213.0, 81.0, 213.0, 90.0, 259.5, 90.0 ],
					"source" : [ "obj-15", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"hidden" : 0,
					"midpoints" : [ 259.5, 184.0, 259.5, 184.0 ],
					"source" : [ "obj-3", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"hidden" : 0,
					"midpoints" : [ 144.5, 181.0, 144.5, 181.0 ],
					"source" : [ "obj-8", 0 ]
				}
