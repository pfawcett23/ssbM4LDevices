...
, 			{
				"box" : 				{
					"annotation" : "Modulator amount",
					"comment" : "Modulator amount",
					"hint" : "Modulator amount",
					"id" : "obj-1",
					"maxclass" : "inlet",
					"numinlets" : 0,
					"numoutlets" : 1,
...
, 			{
				"box" : 				{
					"annotation" : "Modulator frequency ratio",
					"comment" : "Modulator frequency ratio",
					"hint" : "Modulator frequency ratio",
					"id" : "obj-8",
					"maxclass" : "inlet",
					"numinlets" : 0,
					"numoutlets" : 1,
