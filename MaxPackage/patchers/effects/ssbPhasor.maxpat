{
	"patcher" : 	{
		"fileversion" : 1,
		"rect" : [ 206.0, 362.0, 1109.0, 545.0 ],
		"bglocked" : 0,
		"defrect" : [ 206.0, 362.0, 1109.0, 545.0 ],
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"outlettype" : [ "", "float" ],
					"parameter_enable" : 1,
					"patching_rect" : [ 392.0, 12.0, 44.0, 47.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 188.0, 40.0, 44.0, 47.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 640.0, 180.0, 100.0, 18.0 ],
					"text" : "print"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "float" ],
					"parameter_enable" : 1,
					"patching_rect" : [ 460.0, 32.0, 36.0, 15.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 136.0, 148.0, 36.0, 15.0 ],
					"saved_attribute_attributes" : 					{
						"valueof" : 						{
							"parameter_speedlim" : 1.0,
							"parameter_invisible" : 0,
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 8.0, 12.0, 185.0, 20.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "" ],
					"parameter_enable" : 1,
					"patching_rect" : [ 536.0, 32.0, 15.0, 15.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 56.0, 4.0, 15.0, 15.0 ],
					"saved_attribute_attributes" : 					{
						"valueof" : 						{
							"parameter_speedlim" : 1.0,
							"parameter_invisible" : 0,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "int" ],
					"patching_rect" : [ 536.0, 80.0, 30.0, 18.0 ],
					"text" : "abs"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "int" ],
					"patching_rect" : [ 536.0, 52.0, 30.0, 18.0 ],
					"text" : "- 1"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 280.0, 240.0, 25.0, 25.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 280.0, 176.0, 25.0, 25.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 40.0, 176.0, 25.0, 25.0 ]
				}
...
,
					"patching_rect" : [ 40.0, 212.0, 224.0, 20.0 ],
					"saved_object_attributes" : 					{
						"fontname" : "Arial",
						"globalpatchername" : "",
						"default_fontface" : 0,
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 728.0, 60.0, 82.0, 20.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 88.0, 144.0, 50.0, 20.0 ],
					"text" : "Stages"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 728.0, 39.0, 82.0, 20.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 256.0, 89.0, 24.0, 20.0 ],
					"text" : "Q"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 728.0, 18.0, 82.0, 20.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 187.0, 89.0, 53.0, 20.0 ],
					"text" : "Spread"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 643.0, 60.0, 82.0, 20.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 131.0, 89.0, 48.0, 20.0 ],
					"text" : "Ctr Frq"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 643.0, 39.0, 82.0, 20.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 77.0, 89.0, 44.0, 20.0 ],
					"text" : "Depth"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 643.0, 18.0, 82.0, 20.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 25.0, 89.0, 39.0, 20.0 ],
					"text" : "Rate"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "float" ],
					"patching_rect" : [ 425.0, 24.0, 27.0, 27.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 244.009216, 42.0, 40.890175, 40.890175 ],
					"varname" : "phasor_q"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "float" ],
					"patching_rect" : [ 367.0, 24.0, 27.0, 27.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 133.953369, 42.0, 40.890175, 40.890175 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "float" ],
					"patching_rect" : [ 338.0, 24.0, 27.0, 27.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 77.027924, 42.0, 40.890175, 40.890175 ],
					"size" : 101.0,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "float" ],
					"patching_rect" : [ 308.0, 24.0, 27.0, 27.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 22.0, 42.0, 40.890175, 40.890175 ],
					"size" : 201.0,
					"varname" : "phasor_rate"
				}
...
,
					"patching_rect" : [ 280.0, 212.0, 224.0, 20.0 ],
					"saved_object_attributes" : 					{
						"fontname" : "Arial",
						"globalpatchername" : "",
						"default_fontface" : 0,
...
, 			{
				"patchline" : 				{
					...
					"hidden" : 0,
					"midpoints" : [ 545.5, 203.0, 494.5, 203.0 ],
					"source" : [ "obj-7", 0 ]
				}
